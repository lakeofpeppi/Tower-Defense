...
namespace Engine {
    ...
    public:
        ...
        explicit Label(const std::string &text, const std::string &font, int fontSize, float x, float y, unsigned char r = 255, unsigned char g = 255, unsigned char b = 255, unsigned char a = 255, float anchorX = 0, float anchorY = 0);
        /// <summary>
